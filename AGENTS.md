...
- Before downloading any individual dataset, software package, model, or other file expected to exceed 100 MB, obtain explicit user approval. If the size is unknown and may exceed that limit, pause and ask first.
